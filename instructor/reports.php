...
try {
    $sub_sql = "SELECT id, name FROM subjects WHERE instructor_id = :inst_id ORDER BY name ASC";
...
<head>
    <meta charset="UTF-8">
    <title>Reports - Instructor Panel</title>
        ...
        <main class="main-content">
            ...
            <div class="page-header header-with-action">
                <div>
                    ...
                    <p>Generate PDF reports for your classes.</p>
                </div>
            ...
            <div class="table-container">
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="3" style="text-align: center; color: var(--text-muted);">no attendance recorded for this date yet.</td>
                        </tr>
                        ...
                        <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td class="text-muted"><?php echo $att['time_logged'] ? date('m/d/Y h:i A', strtotime($att['time_logged'])) : '-'; ?></td>
                            </tr>
                            <?php endforeach; ?>
