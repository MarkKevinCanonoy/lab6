...
if (!isset($_GET['schedule_id']) || empty($_GET['schedule_id'])) {
    die("please select a schedule to generate a report.");
}
...
<body onload="window.print()">
    ...
    <div class="report-header">
        ...
        <h2>Academic Records & Scheduling</h2>
    </div>
    ...
    <table class="info-table">
        <tr>
            <td style="width: 15%;" class="bold">Subject Name:</td>
            <td style="width: 45%;"><?php echo htmlspecialchars($info['name']); ?></td>
            <td style="width: 27%;" class="bold text-right">Class Date:&nbsp;</td>
            <td style="width: 25%;"><?php echo date('F d, Y', strtotime($info['class_date'])); ?></td>
        </tr>
        <tr>
            <td class="bold">Subject Code:</td>
            <td><?php echo htmlspecialchars($info['code']); ?></td>
            <td class="bold text-right">Report Generated:&nbsp;</td>
            ...
            <?php if(empty($records)): ?>
                <tr>
                    <td colspan="4" class="text-center" style="padding: 20px;">
                        <em>No attendance records found for this schedule.</em>
                    </td>
                </tr>
            <?php else: ?>
                <?php foreach($records as $rec): ?>
                    <tr>
                        ...
                        <td><?php echo $rec['time_logged'] ? date('h:i A', strtotime($rec['time_logged'])) : '-- : --'; ?></td>
                    </tr>
                <?php endforeach; ?>
            <?php endif; ?>
        </tbody>
    ...
    <div style="margin-top: 50px; text-align: right; font-size: 14px;">
        ...
        <p style="margin-right: 40px;"><strong>Authorized Signature</strong></p>
    </div>
